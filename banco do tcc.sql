...
CREATE TABLE tb_entradas (
  ...
  CONSTRAINT FK_entradas_funcionario FOREIGN KEY (id_funcionario) REFERENCES tb_funcionarios(id_funcionario)

);


INSERT INTO tb_entradas (id_funcionario) VALUES (1);
...
CREATE TABLE tb_saidas (
 ...
 CONSTRAINT FK_saidas_funcionario FOREIGN KEY (id_funcionario) REFERENCES tb_funcionarios(id_funcionario)
);

INSERT INTO tb_saidas (id_funcionario) VALUES (1);
INSERT INTO tb_entradas (id_funcionario) VALUES (1);
